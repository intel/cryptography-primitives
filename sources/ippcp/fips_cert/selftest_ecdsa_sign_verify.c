...
IPPFUN(fips_test_status,
       fips_selftest_ippsGFpECSignVerifyDSA_get_size_GFpEC_buff,
       (int* pGFpECBuffSize, Ipp8u* pGFpBuff))
{
    /* return bad status if input pointers are NULL */
    IPP_BADARG_RET((NULL == pGFpECBuffSize) || (NULL == pGFpBuff),
...
IPPFUN(fips_test_status,
       ...
       (int* pDataBuffSize, Ipp8u* pGFpBuff, Ipp8u* pGFpECBuff))
{
    /* return bad status if input pointers are NULL */
    IPP_BADARG_RET((NULL == pDataBuffSize) || (NULL == pGFpBuff) || (NULL == pGFpECBuff),
                   IPPCP_ALGO_SELFTEST_BAD_ARGS_ERR);
       ...
       (Ipp8u * pGFpBuff, Ipp8u* pGFpECBuff, Ipp8u* pDataBuff))
{
    ...
    sts = ippcp_init_set_bn(
        bnMsgDigest, msgWordSize, ippBigNumPOS, (const Ipp32u*)msg_digest, msgWordSize);
    if (sts != ippStsNoErr) {
        MEMORY_FREE_3(pGFpBuff, pGFpECBuff, pDataBuff, memMgmFlag)
        return IPPCP_ALGO_SELFTEST_BAD_ARGS_ERR;
    }
    ...
    IppsBigNumState* bnRegPrivate =
        (IppsBigNumState*)(IPP_ALIGNED_PTR(pLocDataBuff, IPPCP_GFP_ALIGNMENT));
    sts = ippcp_init_set_bn(
        bnRegPrivate, primeWordSize, ippBigNumPOS, (const Ipp32u*)d, primeWordSize);
    if (sts != ippStsNoErr) {
        MEMORY_FREE_3(pGFpBuff, pGFpECBuff, pDataBuff, memMgmFlag)
        return IPPCP_ALGO_SELFTEST_BAD_ARGS_ERR;
    }
    ...
    IppsBigNumState* bnEphPrivate =
        (IppsBigNumState*)(IPP_ALIGNED_PTR(pLocDataBuff, IPPCP_GFP_ALIGNMENT));
    sts = ippcp_init_set_bn(
        bnEphPrivate, primeWordSize, ippBigNumPOS, (const Ipp32u*)k, primeWordSize);
    if (sts != ippStsNoErr) {
        MEMORY_FREE_3(pGFpBuff, pGFpECBuff, pDataBuff, memMgmFlag)
        return IPPCP_ALGO_SELFTEST_BAD_ARGS_ERR;
    }
       ...
       (Ipp8u * pGFpBuff, Ipp8u* pGFpECBuff, Ipp8u* pDataBuff))
{
    ...
    sts = ippsGFpECVerifyDSA(bnMsgDigest, regPublic, bnR, bnS, &verifRes, pEC, pLocDataBuff);
...
IPPFUN(fips_test_status,
       fips_selftest_ippsGFpECPrivateKey,
       (Ipp8u * pGFpBuff, Ipp8u* pGFpECBuff, Ipp8u* pDataBuff))
{
    IppStatus sts                = ippStsNoErr;
    fips_test_status test_result = IPPCP_ALGO_SELFTEST_OK;
    ...
    IppsBigNumState* regPrivate =
        (IppsBigNumState*)(IPP_ALIGNED_PTR(pLocDataBuff, IPPCP_GFP_ALIGNMENT));
    sts = ippcp_init_set_bn(
        regPrivate, primeWordSize, ippBigNumPOS, (const Ipp32u*)msg_digest, primeWordSize);
    if (sts != ippStsNoErr) {
        MEMORY_FREE_3(pGFpBuff, pGFpECBuff, pDataBuff, memMgmFlag)
        return IPPCP_ALGO_SELFTEST_BAD_ARGS_ERR;
    }
    ...
    IppsBigNumState* bnEphPrivate =
        (IppsBigNumState*)(IPP_ALIGNED_PTR(pLocDataBuff, IPPCP_GFP_ALIGNMENT));
    sts = ippcp_init_set_bn(
        bnEphPrivate, primeWordSize, ippBigNumPOS, (const Ipp32u*)msg_digest, primeWordSize);
    if (sts != ippStsNoErr) {
        MEMORY_FREE_3(pGFpBuff, pGFpECBuff, pDataBuff, memMgmFlag)
        return IPPCP_ALGO_SELFTEST_BAD_ARGS_ERR;
    }
    ...
    /* RSA Signature Verification */
    IppECResult verifRes;
    sts = ippsGFpECVerifyDSA(bnMsgDigest, regPublic, bnR, bnS, &verifRes, pEC, pScratchBuffer);
