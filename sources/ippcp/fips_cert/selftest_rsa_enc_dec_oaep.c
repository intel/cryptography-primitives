...
__ALIGN64 static const Ipp8u seed[] = "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff"
                                      ...
                                      "\xff\xff";
// KAT ciphertext
__ALIGN64 static const Ipp8u ctext[] = {
    0x50, 0xc2, 0x3e, 0x2a, 0xd6, 0xe3, 0xf3, 0xb1, 0x0a, 0x57, 0x16, 0xcb, 0xf6, 0x0e, 0xfc, 0xc9,
...
__ALIGN64 static const Ipp8u dataN[] = {
...
__ALIGN64 static const Ipp8u dataD[] = {
...
IPPFUN(fips_test_status,
       fips_selftest_ippsRSAEncryptDecrypt_OAEP_rmf_get_size_keys,
       (int* pKeysBufferSize))
{
       ...
       (int* pBufferSize, Ipp8u* pKeysBuffer))
{
    ...
    IPP_BADARG_RET((NULL == pBufferSize) || (NULL == pKeysBuffer),
...
IPPFUN(fips_test_status,
       fips_selftest_ippsRSAEncrypt_OAEP_rmf,
...
IPPFUN(fips_test_status,
       fips_selftest_ippsRSADecrypt_OAEP_rmf,
       (Ipp8u * pBuffer, Ipp8u* pKeysBuffer))
{
    IppStatus sts                = ippStsNoErr;
    fips_test_status test_result = IPPCP_ALGO_SELFTEST_OK;
