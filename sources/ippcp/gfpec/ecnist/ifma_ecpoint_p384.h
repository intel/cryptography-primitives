 ...
 */
/* clang-format off */
IPP_OWN_DECL(void, ifma_ec_nistp384_mul_point, (P384_POINT_IFMA* r,
 ...
 */
/* clang-format off */
IPP_OWN_DECL(void, ifma_ec_nistp384_mul_pointbase, (P384_POINT_IFMA* r,
                                                    const Ipp8u* pExtendedScalar,
                                                    int scalarBitSize))
/* clang-format on */
/**
 ...
 */
/* clang-format off */
IPP_OWN_DECL(void, ifma_ec_nistp384_get_affine_coords, (m512* rx,
                                                        m512* ry,
 ...
 */
/* clang-format off */
IPP_OWN_DECL(int, ifma_ec_nistp384_is_on_curve, (const P384_POINT_IFMA* p,
 ...
 */
/* clang-format off */
IPP_OWN_DECL(void, ifma_ec_nistp384_add_point, (P384_POINT_IFMA* r,
                                                const P384_POINT_IFMA* p,
 ...
 */
/* clang-format off */
IPP_OWN_DECL(void, ifma_ec_nistp384_add_point_affine, (P384_POINT_IFMA* r,
                                                       const P384_POINT_IFMA* p,
 ...
 */
/* clang-format off */
IPP_OWN_DECL(void, p384r1_select_ap_w4_ifma, (BNU_CHUNK_T* pAffinePoint,
...
IPPCP_INLINE void recode_point_to_mont52(P384_POINT_IFMA* pR,
...
IPPCP_INLINE void recode_point_to_mont64(const IppsGFpECPoint* pR,
                                         P384_POINT_IFMA* pP,
                                         BNU_CHUNK_T* pPool,
                                         ifmaArithMethod* method,
                                         gsModEngine* pME)
