...
/* modulus 2*p */
static const __ALIGN64 Ipp64u p384_x2[LEN52] = { 0x00000001FFFFFFFE, 0x000FE00000000000,
                                                 0x000FFFFFFDFFFFFF, 0x000FFFFFFFFFFFFF,
                                                 0x000FFFFFFFFFFFFF, 0x000FFFFFFFFFFFFF,
                                                 0x000FFFFFFFFFFFFF, 0x00000000001FFFFF };
/* modulus 4*p */
static const __ALIGN64 Ipp64u p384_x4[LEN52] = { 0x00000003FFFFFFFC, 0x000FC00000000000,
                                                 0x000FFFFFFBFFFFFF, 0x000FFFFFFFFFFFFF,
                                                 0x000FFFFFFFFFFFFF, 0x000FFFFFFFFFFFFF,
                                                 0x000FFFFFFFFFFFFF, 0x00000000003FFFFF };
/* modulus 6*p */
static const __ALIGN64 Ipp64u p384_x6[LEN52] = { 0x00000005FFFFFFFA, 0x000FA00000000000,
                                                 0x000FFFFFF9FFFFFF, 0x000FFFFFFFFFFFFF,
                                                 0x000FFFFFFFFFFFFF, 0x000FFFFFFFFFFFFF,
                                                 0x000FFFFFFFFFFFFF, 0x00000000005FFFFF };
/* modulus 8*p */
static const __ALIGN64 Ipp64u p384_x8[LEN52] = { 0x00000007FFFFFFF8, 0x000F800000000000,
                                                 0x000FFFFFF7FFFFFF, 0x000FFFFFFFFFFFFF,
                                                 0x000FFFFFFFFFFFFF, 0x000FFFFFFFFFFFFF,
                                                 0x000FFFFFFFFFFFFF, 0x00000000007FFFFF };

/* mont(a) */
static const __ALIGN64 Ipp64u p384_a[LEN52] = { 0x000FFFFDFFFFFFFF, 0x000FF00000002FFF,
                                                0x000FFFFFFBFFFFFF, 0x000FFFFFFFFFFFCF,
                                                0x000FFFFFFFFFFFFF, 0x000FFFFFFFFFFFFF,
                                                0x000FFFFFFFFFFFFF, 0x00000000000FFFFF };
/* mont(b) */
static const __ALIGN64 Ipp64u p384_b[LEN52] = { 0x00091C81CD08114B, 0x0003708118870D03,
                                                0x000431BF24475444, 0x000209B1920022FC,
                                                0x000E94938AE277F2, 0x000022094E3374BE,
                                                0x000FF9B62B21F41F, 0x00000000000604FB };

/* Montgomery(1)
 * r = 2^(P384_LEN52*DIGIT_SIZE) mod p384
 */
static const __ALIGN64 Ipp64u p384_r[LEN52] = { 0x0000000100000000, 0x000FFFFFFFFFF000,
                                                0x0000000000FFFFFF, 0x0000000000000010,
...
/* clang-format off */
IPP_OWN_DEFN(void, ifma_ec_nistp384_get_affine_coords, (m512* prx,
                                                        m512* pry,
                                                        const P384_POINT_IFMA* a))
/* clang-format on */
{
    m512 z1, z2, z3;
...
IPP_OWN_DEFN(void, ifma_ec_nistp384_dbl_point, (P384_POINT_IFMA * r, const P384_POINT_IFMA* p))
{
    ...
    norm_dual(r->x, x2, r->y, y2); /* normalization */
    lnorm(r->z, z2);
    return;
}

/* clang-format off */
IPP_OWN_DEFN(void, ifma_ec_nistp384_add_point, (P384_POINT_IFMA* r,
                                                const P384_POINT_IFMA* p,
                                                const P384_POINT_IFMA* q))
/* clang-format on */
{
    /*
     * Algorithm (Gueron - Enhanced Montgomery Multiplication)
    ...
    /* normalization */
    lnorm_dual(S1, S1, S2, S2); /* (need by correct compute F = D - C) */

    /* u1 = x1*z2^2 (A) */
    /* u2 = x2*z1^2 (B) */
    mul_dual(U1, *x1, U1, U2, *x2, U2);

    lnorm_dual(U1, U1, U2, U2); /* normalization */
...
/* clang-format off */
IPP_OWN_DEFN(void, ifma_ec_nistp384_add_point_affine, (P384_POINT_IFMA* r,
                                                       const P384_POINT_IFMA* p,
                                                       const P384_POINT_AFFINE_IFMA* q))
/* clang-format on */
{
    /*
     * Algorithm (Gueron - Enhanced Montgomery Multiplication)
...
/* clang-format off */
IPP_OWN_DEFN(int, ifma_ec_nistp384_is_on_curve, (const P384_POINT_IFMA* p,
...
IPPCP_INLINE void extract_table_point(P384_POINT_IFMA* r,
                                      const Ipp32s digit,
                                      const P384_POINT_IFMA* tbl)
{
    Ipp32s idx = digit - 1;
...
/* r = n*P = (P + P + ... + P) */
/* clang-format off */
IPP_OWN_DEFN(void, ifma_ec_nistp384_mul_point, (P384_POINT_IFMA* r,
                                                const P384_POINT_IFMA* p,
...
#include "gfpec/ecnist/ifma_ecprecomp4_p384.h"

/* mul point base */
#define BP_WIN_SIZE BASE_POINT_WIN_SIZE
#define BP_N_ENTRY  BASE_POINT_N_ENTRY

IPPCP_INLINE void extract_point_affine(P384_POINT_AFFINE_IFMA* r,
...
/* clang-format off */
IPP_OWN_DEFN(void, p384r1_select_ap_w4_ifma, (BNU_CHUNK_T* pAffinePoint,
...
/* clang-format off */
IPP_OWN_DEFN(void, ifma_ec_nistp384_mul_pointbase, (P384_POINT_IFMA* r,
                                                    const Ipp8u* pExtendedScalar,
                                                    int scalarBitSize))
/* clang-format on */
{
