...
#if (_IPP_ARCH == _IPP_ARCH_IA32)
/* clang-format off */
IPP_OWN_DEFN (static BNU_CHUNK_T*, p192r1_mul_montl, (BNU_CHUNK_T* pR,
...
/* clang-format off */
IPP_OWN_DEFN (static BNU_CHUNK_T*, p192r1_sqr_montl, (BNU_CHUNK_T* pR,
                                                      const BNU_CHUNK_T* pA,
                                                      gsEngine* pGFE))
/* clang-format on */
{
...
static BNU_CHUNK_T one[] = { 1, 0, 0, 0, 0, 0 };

/* clang-format off */
IPP_OWN_DEFN (static BNU_CHUNK_T*, p192r1_to_mont, (BNU_CHUNK_T* pR,
                                                    const BNU_CHUNK_T* pA,
                                                    gsEngine* pGFE))
/* clang-format on */
{
...
/* clang-format off */
IPP_OWN_DEFN(static BNU_CHUNK_T*, p192r1_mont_back, (BNU_CHUNK_T* pR,
                                                     const BNU_CHUNK_T* pA,
                                                     gsEngine* pGFE))
/* clang-format on */
{
...
/* clang-format off */
IPP_OWN_DEFN (static BNU_CHUNK_T*, p192r1_to_mont_slm, (BNU_CHUNK_T* pR,
                                                        const BNU_CHUNK_T* pA,
                                                        gsEngine* pGFE))
/* clang-format on */
{
...
/* clang-format off */
IPP_OWN_DEFN(static BNU_CHUNK_T*, p192r1_mont_back_slm, (BNU_CHUNK_T* pR,
                                                         const BNU_CHUNK_T* pA,
                                                         gsEngine* pGFE))
/* clang-format on */
{
...
{
    /* clang-format off */
    static gsModMethod m = { p192r1_to_mont,
                             p192r1_mont_back,
                             p192r1_mul_montl,
                             p192r1_sqr_montl,
                             NULL,
