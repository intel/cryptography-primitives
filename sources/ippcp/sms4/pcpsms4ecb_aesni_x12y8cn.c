...
*/
static int cpSMS4_ECB_aesni_x4(Ipp8u* pOut, const Ipp8u* pInp, int len, const Ipp32u* pRKey)
{
...
*/
static int cpSMS4_ECB_aesni_x8(Ipp8u* pOut, const Ipp8u* pInp, int len, const Ipp32u* pRKey)
{
...
IPP_OWN_DECL(int, cpSMS4_ECB_aesni_x12, (Ipp8u* pOut,
                                         ...
                                         int len,
                                         const Ipp32u* pRKey))
IPP_OWN_DEFN(int, cpSMS4_ECB_aesni_x12, (Ipp8u* pOut,
                                         const Ipp8u* pInp,
                                         int len,
                                         const Ipp32u* pRKey))
/* clang-format on */
