...
void EXP52x60_pub65537_mb4(int64u out[][4],
                           const int64u base[][4],
                           ...
                           int64u work_buffer[][4])
{
   ...
   /* convert base into redundant domain */
   ifma_amm52x60_mb4((int64u *)red_X, (int64u *)base, (int64u *)toMont, (int64u *)modulus, (int64u *)k0);

   /* exponentition 65537 = 0x10001 */
   SQUARE_52x60_mb4((int64u *)red_Y, (int64u *)red_X, (int64u *)modulus, (int64u *)k0);
