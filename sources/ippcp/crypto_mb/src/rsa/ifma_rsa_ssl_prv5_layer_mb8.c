...
#define LEN64 (NUMBER_OF_DIGITS(FACTOR_BITLEN, 64))
   ...
   __ALIGN64 int64u p_mb4[LEN52][4];
   __ALIGN64 int64u q_mb4[LEN52][4];
   __ALIGN64 int64u d_mb4[LEN64][4];
   __ALIGN64 int64u rr_mb4[LEN52][4];
   __ALIGN64 int64u xp_mb4[LEN52][4];
   __ALIGN64 int64u xq_mb4[LEN52][4];
   __ALIGN64 int64u inp_mb4[LEN52 * 2][4];
   /* allocate stack for red(undant) result, multiplier, for exponent X and for pre-computed table of base powers */
   __ALIGN64 int64u work_buffer[LEN52 * 2 + 1 + (LEN64 + 1) + (1 << EXP_WIN_SIZE) * LEN52][4];

   /* convert input to ifma fmt */
   zero_mb4(inp_mb4, LEN52 * 2);
   ifma_HexStr4_to_mb4(inp_mb4, from_pa, RSA_BITLEN);
   ...
   */
   ...
   /* compute to_Montgomery domain converters */
   ifma_montRR52x_mb4(rr_mb4, q_mb4, FACTOR_BITLEN);
   /* xq = x mod q */
   ifma_amred52x10_mb4(xq_mb4, (const int64u(*)[4])inp_mb4, (const int64u(*)[4])q_mb4, k0_mb4);
   ifma_amm52x10_mb4((int64u *)xq_mb4, (int64u *)xq_mb4, (int64u *)rr_mb4, (int64u *)q_mb4, k0_mb4);
   ifma_modsub52x10_mb4(xq_mb4, (const int64u(*)[4])xq_mb4, (const int64u(*)[4])q_mb4, (const int64u(*)[4])q_mb4); // ??
   /* re-arrange exps to ifma */
   ...
   */
   ...
   /* compute to_Montgomery domain converters */
   ifma_montRR52x_mb4(rr_mb4, p_mb4, FACTOR_BITLEN);
   /* xp = x mod p */
   ifma_amred52x10_mb4(xp_mb4, (const int64u(*)[4])inp_mb4, (const int64u(*)[4])p_mb4, k0_mb4);
   ifma_amm52x10_mb4((int64u *)xp_mb4, (int64u *)xp_mb4, (int64u *)rr_mb4, (int64u *)p_mb4, k0_mb4);
   ifma_modsub52x10_mb4(xp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])p_mb4, (const int64u(*)[4])p_mb4); // ??
   /* re-arrange exps to ifma */
   ...
   */
   ...
   /* xp = (xp-xq) mod p */
   ifma_modsub52x10_mb4(inp_mb4, (const int64u(*)[4])xq_mb4, (const int64u(*)[4])p_mb4, (const int64u(*)[4])p_mb4); /* for specific case p<q */
   ifma_modsub52x10_mb4(xp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])inp_mb4, (const int64u(*)[4])p_mb4);

   /* xp = (xp*coef) mod p */
   ifma_BN_to_mb4(inp_mb4, iq_pa, FACTOR_BITLEN);                                                                  /* coef */
   ifma_amm52x10_mb4((int64u *)xp_mb4, (int64u *)xp_mb4, (int64u *)rr_mb4, (int64u *)p_mb4, k0_mb4);               /* -> mont domain */
   ifma_amm52x10_mb4((int64u *)xp_mb4, (int64u *)xp_mb4, (int64u *)inp_mb4, (int64u *)p_mb4, k0_mb4);              /* mmul */
   ifma_modsub52x10_mb4(xp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])p_mb4, (const int64u(*)[4])p_mb4); /* correction */

   /* xp = (xp*q + xq) */
   zero_mb4(inp_mb4, LEN52 * 2);
   copy_mb4(inp_mb4, (const int64u(*)[4])xq_mb4, LEN52);
   ifma_addmul52x10_mb4(inp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])q_mb4);

   /* convert result from ifma fmt */
   ifma_mb4_to_HexStr4(to_pa, (const int64u(*)[4])inp_mb4, RSA_BITLEN);
...
#define LEN64 (NUMBER_OF_DIGITS(FACTOR_BITLEN, 64))
   ...
   */
   ...
   ifma_montRR52x_mb4(rr_mb4, q_mb4, FACTOR_BITLEN);
   /* xq = x mod q */
   ifma_amred52x20_mb4(xq_mb4, (const int64u(*)[4])inp_mb4, (const int64u(*)[4])q_mb4, k0_mb4);
   ifma_amm52x20_mb4((int64u *)xq_mb4, (int64u *)xq_mb4, (int64u *)rr_mb4, (int64u *)q_mb4, k0_mb4);
   ifma_modsub52x20_mb4(xq_mb4, (const int64u(*)[4])xq_mb4, (const int64u(*)[4])q_mb4, (const int64u(*)[4])q_mb4); // ??
   /* re-arrange exps to ifma */
   ifma_BN_transpose_copy_mb4(d_mb4, dq_pa, FACTOR_BITLEN);
   ...
   */
   ...
   ifma_montRR52x_mb4(rr_mb4, p_mb4, FACTOR_BITLEN);
   /* xp = x mod p */
   ifma_amred52x20_mb4(xp_mb4, (const int64u(*)[4])inp_mb4, (const int64u(*)[4])p_mb4, k0_mb4);
   ifma_amm52x20_mb4((int64u *)xp_mb4, (int64u *)xp_mb4, (int64u *)rr_mb4, (int64u *)p_mb4, k0_mb4);
   ifma_modsub52x20_mb4(xp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])p_mb4, (const int64u(*)[4])p_mb4); // ??
   /* re-arrange exps to ifma */
   ifma_BN_transpose_copy_mb4(d_mb4, dp_pa, FACTOR_BITLEN);
   ...
   */
   ...
   /* xp = (xp-xq) mod p */
   ifma_modsub52x20_mb4(inp_mb4, (const int64u(*)[4])xq_mb4, (const int64u(*)[4])p_mb4, (const int64u(*)[4])p_mb4); /* for specific case p<q */
   ifma_modsub52x20_mb4(xp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])inp_mb4, (const int64u(*)[4])p_mb4);

   /* xp = (xp*coef) mod p */
   ifma_BN_to_mb4(inp_mb4, iq_pa, FACTOR_BITLEN);                                                                  /* coef */
   ifma_amm52x20_mb4((int64u *)xp_mb4, (int64u *)xp_mb4, (int64u *)rr_mb4, (int64u *)p_mb4, k0_mb4);               /* -> mont domain */
   ifma_amm52x20_mb4((int64u *)xp_mb4, (int64u *)xp_mb4, (int64u *)inp_mb4, (int64u *)p_mb4, k0_mb4);              /* mmul */
   ifma_modsub52x20_mb4(xp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])p_mb4, (const int64u(*)[4])p_mb4); /* correction */

   /* xp = (xp*q + xq) */
   zero_mb4(inp_mb4, LEN52 * 2);
   copy_mb4(inp_mb4, (const int64u(*)[4])xq_mb4, LEN52);
   ifma_addmul52x20_mb4(inp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])q_mb4);
...
#define LEN64 (NUMBER_OF_DIGITS(FACTOR_BITLEN, 64))
   ...
   */
   ...
   ifma_montRR52x_mb4(rr_mb4, q_mb4, FACTOR_BITLEN);
   /* xq = x mod q */
   ifma_amred52x30_mb4(xq_mb4, (const int64u(*)[4])inp_mb4, (const int64u(*)[4])q_mb4, k0_mb4);
   ifma_amm52x30_mb4((int64u *)xq_mb4, (int64u *)xq_mb4, (int64u *)rr_mb4, (int64u *)q_mb4, k0_mb4);
   ifma_modsub52x30_mb4(xq_mb4, (const int64u(*)[4])xq_mb4, (const int64u(*)[4])q_mb4, (const int64u(*)[4])q_mb4); // ??
   /* re-arrange exps to ifma */
   ifma_BN_transpose_copy_mb4(d_mb4, dq_pa, FACTOR_BITLEN);
   ...
   */
   ...
   ifma_montRR52x_mb4(rr_mb4, p_mb4, FACTOR_BITLEN);
   /* xp = x mod p */
   ifma_amred52x30_mb4(xp_mb4, (const int64u(*)[4])inp_mb4, (const int64u(*)[4])p_mb4, k0_mb4);
   ifma_amm52x30_mb4((int64u *)xp_mb4, (int64u *)xp_mb4, (int64u *)rr_mb4, (int64u *)p_mb4, k0_mb4);
   ifma_modsub52x30_mb4(xp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])p_mb4, (const int64u(*)[4])p_mb4); // ??
   /* re-arrange exps to ifma */
   ifma_BN_transpose_copy_mb4(d_mb4, dp_pa, FACTOR_BITLEN);
   ...
   */
   ...
   /* xp = (xp-xq) mod p */
   ifma_modsub52x30_mb4(inp_mb4, (const int64u(*)[4])xq_mb4, (const int64u(*)[4])p_mb4, (const int64u(*)[4])p_mb4); /* for specific case p<q */
   ifma_modsub52x30_mb4(xp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])inp_mb4, (const int64u(*)[4])p_mb4);

   /* xp = (xp*coef) mod p */
   ifma_BN_to_mb4(inp_mb4, iq_pa, FACTOR_BITLEN);                                                                  /* coef */
   ifma_amm52x30_mb4((int64u *)xp_mb4, (int64u *)xp_mb4, (int64u *)rr_mb4, (int64u *)p_mb4, k0_mb4);               /* -> mont domain */
   ifma_amm52x30_mb4((int64u *)xp_mb4, (int64u *)xp_mb4, (int64u *)inp_mb4, (int64u *)p_mb4, k0_mb4);              /* mmul */
   ifma_modsub52x30_mb4(xp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])p_mb4, (const int64u(*)[4])p_mb4); /* correction */

   /* xp = (xp*q + xq) */
   zero_mb4(inp_mb4, LEN52 * 2);
   copy_mb4(inp_mb4, (const int64u(*)[4])xq_mb4, LEN52);
   ifma_addmul52x30_mb4(inp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])q_mb4);
...
#define LEN64 (NUMBER_OF_DIGITS(FACTOR_BITLEN, 64))
   ...
   */
   ...
   ifma_montRR52x_mb4(rr_mb4, q_mb4, FACTOR_BITLEN);
   /* xq = x mod q */
   ifma_amred52x40_mb4(xq_mb4, (const int64u(*)[4])inp_mb4, (const int64u(*)[4])q_mb4, k0_mb4);
   ifma_amm52x40_mb4((int64u *)xq_mb4, (int64u *)xq_mb4, (int64u *)rr_mb4, (int64u *)q_mb4, k0_mb4);
   ifma_modsub52x40_mb4(xq_mb4, (const int64u(*)[4])xq_mb4, (const int64u(*)[4])q_mb4, (const int64u(*)[4])q_mb4); // ??
   /* re-arrange exps to ifma */
   ifma_BN_transpose_copy_mb4(d_mb4, dq_pa, FACTOR_BITLEN);
   ...
   */
   ...
   ifma_montRR52x_mb4(rr_mb4, p_mb4, FACTOR_BITLEN);
   /* xp = x mod p */
   ifma_amred52x40_mb4(xp_mb4, (const int64u(*)[4])inp_mb4, (const int64u(*)[4])p_mb4, k0_mb4);
   ifma_amm52x40_mb4((int64u *)xp_mb4, (int64u *)xp_mb4, (int64u *)rr_mb4, (int64u *)p_mb4, k0_mb4);
   ifma_modsub52x40_mb4(xp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])p_mb4, (const int64u(*)[4])p_mb4); // ??
   /* re-arrange exps to ifma */
   ifma_BN_transpose_copy_mb4(d_mb4, dp_pa, FACTOR_BITLEN);
   ...
   */
   ...
   /* xp = (xp-xq) mod p */
   ifma_modsub52x40_mb4(inp_mb4, (const int64u(*)[4])xq_mb4, (const int64u(*)[4])p_mb4, (const int64u(*)[4])p_mb4); /* for specific case p<q */
   ifma_modsub52x40_mb4(xp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])inp_mb4, (const int64u(*)[4])p_mb4);

   /* xp = (xp*coef) mod p */
   ifma_BN_to_mb4(inp_mb4, iq_pa, FACTOR_BITLEN);                                                                  /* coef */
   ifma_amm52x40_mb4((int64u *)xp_mb4, (int64u *)xp_mb4, (int64u *)rr_mb4, (int64u *)p_mb4, k0_mb4);               /* -> mont domain */
   ifma_amm52x40_mb4((int64u *)xp_mb4, (int64u *)xp_mb4, (int64u *)inp_mb4, (int64u *)p_mb4, k0_mb4);              /* mmul */
   ifma_modsub52x40_mb4(xp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])p_mb4, (const int64u(*)[4])p_mb4); /* correction */

   /* xp = (xp*q + xq) */
   zero_mb4(inp_mb4, LEN52 * 2);
   copy_mb4(inp_mb4, (const int64u(*)[4])xq_mb4, LEN52);
   ifma_addmul52x40_mb4(inp_mb4, (const int64u(*)[4])xp_mb4, (const int64u(*)[4])q_mb4);
