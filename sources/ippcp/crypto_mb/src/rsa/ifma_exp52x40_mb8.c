                  ...
                  int64u work_buffer[][8])
{
   ...
   */
    ...
    ifma_amm52x40_mb8((int64u*)red_table[0],
                      (int64u*)red_X,
                      (int64u*)toMont,
                      (int64u*)modulus,
                      (int64u*)k0);

    ifma_amm52x40_mb8((int64u*)red_table[1],
                      (int64u*)base,
                      (int64u*)toMont,
                      (int64u*)modulus,
                      (int64u*)k0);
    ...
    for (idx = 1; idx < (1 << EXP_WIN_SIZE) / 2; idx++) {
        SQUARE_52x40_mb8((int64u*)red_table[2 * idx],
                         (int64u*)red_table[idx],
                         (int64u*)modulus,
                         (int64u*)k0);
        ifma_amm52x40_mb8((int64u*)red_table[2 * idx + 1],
...
/* series of squaring */
            ...
            /* and multiply */
            ifma_amm52x40_mb8((int64u*)red_Y,
                              (int64u*)red_Y,
                              (int64u*)red_X,
                              (int64u*)modulus,
                              (int64u*)k0);
...
#define USE_AMS
#ifdef USE_AMS
#define SQUARE_52x40_mb4(out, Y, mod, k0) \
    AMS52x40_diagonal_mb4((int64u*)(out), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));
#else
#define SQUARE_52x40_mb4(out, Y, mod, k0) \
    ifma_amm52x40_mb4((int64u*)(out), (int64u*)(Y), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));
#endif
                  ...
                  int64u work_buffer[][4])
{
    ...
    */
    arr_pint64u_x4 red_table =
        (arr_pint64u_x4)(expz + LEN64 +
                         1); // total of LEN52<<EXP_WIN_SIZE = LEN52 * 2^EXP_WIN_SIZE arr_pint64u_x4 structures
    ...
    for (int idx = 1; idx < (1 << EXP_WIN_SIZE) / 2; idx++) {
        ...
        SQUARE_52x40_mb4((int64u*)red_table[2 * idx],
                         (int64u*)red_table[idx],
                         (int64u*)modulus,
                         (int64u*)k0);

        // redx_table[2*idx] = (base^(2*idx))*2^((LEN52/2)*DIGIT_SIZE) mod modulus
        ifma_ahmr52x40_mb4((int64u*)redx_table[2 * idx],
                           (int64u*)red_table[2 * idx],
                           (int64u*)modulus,
                           (int64u*)k0);
        ...
        ifma_ahmr52x40_mb4((int64u*)redx_table[2 * idx + 1],
                           (int64u*)red_table[2 * idx + 1],
                           (int64u*)modulus,
                           (int64u*)k0);
    }
    ...
    for (exp_bit_no -= EXP_WIN_SIZE; exp_bit_no >= 0; exp_bit_no -= EXP_WIN_SIZE) {
        ...
        const __m256i T0 =
            _mm256_sll_epi64(((const __m256i*)expz[exp_chunk_no + 1])[0], shift_left_n);
        ...
        AMS4x52x40_diagonal_stitched_with_extract_mb4((int64u*)red_Y,
                                                      (U64*)mulb,
                                                      (U64*)mulbx,
                                                      (int64u*)red_Y,
                                                      (int64u*)modulus,
        ...
        ifma_ahmm52x40_mb4((int64u*)red_Y,
                           (int64u*)red_Y,
                           (int64u*)mulb,
                           (int64u*)mulbx,
                           (int64u*)modulus,
