...
void ifma_extract_amm52x5_mb8(int64u* out_mb8,
                              ...
                              const int64u* k0_mb8)
{
    ...
    U64 mulB00, mulB01, mulB02, mulB03, mulB04;
    U64 K = loadu64(k0_mb8); /* k0[] */
    __mmask8 k;
    __ALIGN64 U64 inpB_mb8[5];
    int itr;
    ...
    for (itr = 0; itr < 5; itr++) {
        ...
        fma52hi_mem(res04, get_zero64(), Bi, inpA_mb8, 64 * 4);
