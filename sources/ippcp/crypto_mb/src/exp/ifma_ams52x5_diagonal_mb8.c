...
void AMS52x5_diagonal_mb8(int64u* out_mb,
                          ...
                          const int64u* k0_mb)
{
    ...
    // Normalization
    r[0] = and64_const(res5, DIGIT_MASK);
    res6 = add64(res6, srli64(res5, DIGIT_SIZE));
    r[1] = and64_const(res6, DIGIT_MASK);
    res7 = add64(res7, srli64(res6, DIGIT_SIZE));
    r[2] = and64_const(res7, DIGIT_MASK);
    res8 = add64(res8, srli64(res7, DIGIT_SIZE));
    r[3] = and64_const(res8, DIGIT_MASK);
    res9 = add64(res9, srli64(res8, DIGIT_SIZE));
    r[4] = and64_const(res9, DIGIT_MASK);
}
