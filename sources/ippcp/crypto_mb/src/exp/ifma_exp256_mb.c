...
#define USE_AMS
#ifdef USE_AMS
#define SQUARE_52x5_mb8(out, Y, mod, k0) \
    AMS52x5_diagonal_mb8((int64u*)(out), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));

#ifdef USE_AMS_5x
#define SQUARE_5x52x5_mb8(out, Y, mod, k0) \
    AMS5x52x5_diagonal_mb8((int64u*)(out), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));
#else
#define SQUARE_5x52x5_mb8(out, Y, mod, k0)                                               \
    AMS52x5_diagonal_mb8((int64u*)(out), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));   \
    AMS52x5_diagonal_mb8((int64u*)(out), (int64u*)(out), (int64u*)(mod), (int64u*)(k0)); \
    AMS52x5_diagonal_mb8((int64u*)(out), (int64u*)(out), (int64u*)(mod), (int64u*)(k0)); \
    AMS52x5_diagonal_mb8((int64u*)(out), (int64u*)(out), (int64u*)(mod), (int64u*)(k0)); \
    AMS52x5_diagonal_mb8((int64u*)(out), (int64u*)(out), (int64u*)(mod), (int64u*)(k0));
#endif
#else
#define SQUARE_52x5_mb8(out, Y, mod, k0) \
    ifma_amm52x5_mb8((int64u*)(out), (int64u*)(Y), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));
#define SQUARE_5x52x5_mb8(out, Y, mod, k0)                                                       \
    ifma_amm52x5_mb8((int64u*)(out), (int64u*)(Y), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0)); \
    /* clang-format off */                                                                        \
    ifma_amm52x5_mb8(                                                                            \
...
#define BITSIZE_MODULUS (256)
#define LEN52           (NUMBER_OF_DIGITS(BITSIZE_MODULUS, DIGIT_SIZE)) //5
#define LEN64           (NUMBER_OF_DIGITS(BITSIZE_MODULUS, 64))         //4
                       ...
                       int64u scratchBuffer[][8])
{
   ...
   */
    ...
    ifma_amm52x5_mb8((U64*)red_table[0],
                     (const U64*)red_X,
                     (const U64*)toMont,
                     (const U64*)modulus,
                     (int64u*)k0);
    ifma_amm52x5_mb8((U64*)red_table[1],
                     (const U64*)base,
                     (const U64*)toMont,
                     (const U64*)modulus,
                     (int64u*)k0);
    ...
    for (idx = 1; idx < (1 << EXP_WIN_SIZE) / 2; idx++) {
        SQUARE_52x5_mb8((int64u*)red_table[2 * idx],
                        (int64u*)red_table[idx],
                        (int64u*)modulus,
                        (int64u*)k0);
        ifma_amm52x5_mb8((U64*)red_table[2 * idx + 1],
                         (const U64*)red_table[2 * idx],
                         (const U64*)red_table[1],
                         (const U64*)modulus,
                         (int64u*)k0);
    }
...
/* series of squaring */
#if EXP_WIN_SIZE == 5
            SQUARE_5x52x5_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
#else
            SQUARE_52x5_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
            SQUARE_52x5_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
            SQUARE_52x5_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
            SQUARE_52x5_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
#endif
            ...
            /* extract pre-computed multiplier from the table */
            {
                ...
                ifma_extract_amm52x5_mb8((int64u*)red_Y,
                                         (int64u*)red_Y,
                                         red_table,
