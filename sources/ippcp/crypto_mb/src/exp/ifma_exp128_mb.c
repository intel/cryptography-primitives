...
#define USE_AMS
#ifdef USE_AMS
#define SQUARE_52x3_mb8(out, Y, mod, k0) \
    AMS52x3_diagonal_mb8((int64u*)(out), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));

#ifdef USE_AMS_5x
#define SQUARE_5x52x3_mb8(out, Y, mod, k0) \
    AMS5x52x3_diagonal_mb8((int64u*)(out), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));
#else
#define SQUARE_5x52x3_mb8(out, Y, mod, k0)                                               \
    AMS52x3_diagonal_mb8((int64u*)(out), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));   \
    AMS52x3_diagonal_mb8((int64u*)(out), (int64u*)(out), (int64u*)(mod), (int64u*)(k0)); \
    AMS52x3_diagonal_mb8((int64u*)(out), (int64u*)(out), (int64u*)(mod), (int64u*)(k0)); \
    AMS52x3_diagonal_mb8((int64u*)(out), (int64u*)(out), (int64u*)(mod), (int64u*)(k0)); \
    AMS52x3_diagonal_mb8((int64u*)(out), (int64u*)(out), (int64u*)(mod), (int64u*)(k0));
#endif
#else
#define SQUARE_52x3_mb8(out, Y, mod, k0) \
    ifma_amm52x3_mb8((int64u*)(out), (int64u*)(Y), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));
#define SQUARE_5x52x3_mb8(out, Y, mod, k0)                                                       \
    ifma_amm52x3_mb8((int64u*)(out), (int64u*)(Y), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0)); \
    /* clang-format off */                                                                       \
    ifma_amm52x3_mb8(                                                                            \
...
#define BITSIZE_MODULUS (128)
#define LEN52           (NUMBER_OF_DIGITS(BITSIZE_MODULUS, DIGIT_SIZE)) // 3
#define LEN64           (NUMBER_OF_DIGITS(BITSIZE_MODULUS, 64))         // 2
                       ...
                       int64u scratchBuffer[][8])
{
   ...
   */
    ...
    ifma_amm52x3_mb8((int64u*)red_table[0],
                     (int64u*)red_X,
                     (int64u*)toMont,
                     (int64u*)modulus,
                     (int64u*)k0);

    ifma_amm52x3_mb8((int64u*)red_table[1],
                     (int64u*)base,
                     (int64u*)toMont,
                     (int64u*)modulus,
                     (int64u*)k0);
    ...
    for (idx = 1; idx < (1 << EXP_WIN_SIZE) / 2; idx++) {
        SQUARE_52x3_mb8((int64u*)red_table[2 * idx],
                        (int64u*)red_table[idx],
                        (int64u*)modulus,
                        (int64u*)k0);
        ifma_amm52x3_mb8((int64u*)red_table[2 * idx + 1],
...
/* series of squaring */
#if EXP_WIN_SIZE == 5
            SQUARE_5x52x3_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
#else
            SQUARE_52x3_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
            SQUARE_52x3_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
            SQUARE_52x3_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
            SQUARE_52x3_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
#endif
            ...
            /* extract pre-computed multiplier from the table */
            {
                ...
                ifma_extract_amm52x3_mb8((int64u*)red_Y,
                                         (int64u*)red_Y,
                                         red_table,
    ...
    _mm512_store_si512(red_X, _mm512_set1_epi64(1));
    ifma_amm52x3_mb8((int64u*)out, (int64u*)red_Y, (int64u*)red_X, (int64u*)modulus, (int64u*)k0);
