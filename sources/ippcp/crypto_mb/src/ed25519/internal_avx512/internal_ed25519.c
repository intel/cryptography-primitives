...
void ed25519_expand_key(int8u* pa_secret_expand[8], const ed25519_private_key* const pa_secret_key[8])
{
...
mbx_status internal_avx512_ed25519_public_key_mb8(ed25519_public_key* pa_public_key[8],
