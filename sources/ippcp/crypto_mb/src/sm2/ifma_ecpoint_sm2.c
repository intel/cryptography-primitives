...
const U64* MB_FUNC_NAME(ifma_ec_sm2_coord_one_)(void) { return (U64*)psm2_r_mb; }
...
// cost: 3S+8M+7A
*/
void MB_FUNC_NAME(ifma_ec_sm2_add_point_affine_)(SM2_POINT* r,
                                                 const SM2_POINT* p,
...
__MBX_INLINE void MB_FUNC_NAME(extract_point_affine_)(SM2_POINT_AFFINE* r,
                                                      const SINGLE_SM2_POINT_AFFINE* tbl,
                                                      U64 idx)
{
    /* decrement index (the table does not contain [0]*P */
...
__ALIGN64 static const int64u mont_a_psm2_mb[PSM2_LEN52][8] = { { REP8_DECL(0x000fffffffffffcf) },
                                                                { REP8_DECL(0x000cf00000030fff) },
                                                                { REP8_DECL(0x000fffffffffffff) },
                                                                { REP8_DECL(0x000fffffffffffff) },
                                                                { REP8_DECL(0x0000ffffffceffff) } };
__ALIGN64 static const int64u mont_b_psm2_mb[PSM2_LEN52][8] = { { REP8_DECL(0x00030632bc0dd422) },
