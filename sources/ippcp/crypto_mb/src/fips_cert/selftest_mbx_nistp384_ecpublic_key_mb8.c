...
fips_test_status fips_selftest_mbx_nistp384_ecpublic_key_mb8(void)
{
    ...
    sts = mbx_nistp384_ecdsa_sign_mb8(pa_sign_r,
                                      pa_sign_s,
                                      pa_pub_msg_digest,
                                      pa_prv_k,
                                      pa_prv_d,
    ...
    sts = mbx_nistp384_ecdsa_verify_mb8(_pa_sign_r,
                                        _pa_sign_s,
                                        pa_pub_msg_digest,
                                        _pa_pub_Qx,
                                        _pa_pub_Qy,
...
fips_test_status fips_selftest_mbx_nistp384_ecpublic_key_ssl_mb8(void)
{
    ...
    // sign and verify with the generated keypair
    sts = mbx_nistp384_ecdsa_sign_ssl_mb8(pa_sign_r,
                                          pa_sign_s,
                                          pa_pub_msg_digest,
                                          pa_prv_k,
                                          pa_prv_d,
    ...
    sts = mbx_nistp384_ecdsa_verify_ssl_mb8((const ECDSA_SIG* const*)pa_sig,
                                            pa_pub_msg_digest,
                                            _pa_pub_Qx,
                                            _pa_pub_Qy,
                                            NULL,
