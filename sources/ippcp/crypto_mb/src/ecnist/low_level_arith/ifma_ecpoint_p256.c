...
//
*/
void MB_FUNC_NAME(ifma_ec_nistp256_add_point_)(P256_POINT* r,
                                               const P256_POINT* p,
                                               const P256_POINT* q)
{
    /* coordinates of p */
    ...
    /* temporary */
    __ALIGN64 U64 Ux1[P256_LEN52];
    __ALIGN64 U64 Ux2[P256_LEN52];
...
// cost: 3S+8M+7A
*/
void MB_FUNC_NAME(ifma_ec_nistp256_add_point_affine_)(P256_POINT* r,
                                                      const P256_POINT* p,
...
__MBX_INLINE void MB_FUNC_NAME(extract_point_affine_)(P256_POINT_AFFINE* r,
                                                      const SINGLE_P256_POINT_AFFINE* tbl,
                                                      U64 idx)
{
    /* decrement index (the table does not contain [0]*P */
