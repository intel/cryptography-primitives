...
//
*/
void MB_FUNC_NAME(ifma_ec_nistp384_add_point_)(P384_POINT* r,
                                               const P384_POINT* p,
                                               const P384_POINT* q)
{
    /* coordinates of p */
    ...
    /* temporary */
    __ALIGN64 U64 Ux1[P384_LEN52];
    __ALIGN64 U64 Ux2[P384_LEN52];
...
// cost: 3S+8M+7A
*/
void MB_FUNC_NAME(ifma_ec_nistp384_add_point_affine_)(P384_POINT* r,
                                                      const P384_POINT* p,
 ...
 */
void MB_FUNC_NAME(ifma_ec_nistp384_mul_point_)(P384_POINT* r,
                                               const P384_POINT* p,
                                               const U64 scalar[])
{
    /* pre-computed table */
...
__MBX_INLINE void MB_FUNC_NAME(extract_point_affine_)(P384_POINT_AFFINE* r,
                                                      const SINGLE_P384_POINT_AFFINE* tbl,
                                                      U64 idx)
{
    /* decrement index (the table does not contain [0]*P */
    ...
    /* assume the point at infinity is what need */
    ax0 = ax1 = ax2 = ax3 = ax4 = ax5 = ax6 = ax7 = ay0 = ay1 = ay2 = ay3 = ay4 = ay5 = ay6 = ay7 =
        get_zero64();
