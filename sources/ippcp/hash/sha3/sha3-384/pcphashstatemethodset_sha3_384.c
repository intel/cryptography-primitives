...
/*
//    Name: ippsHashStateMethodSet_SHA3_384
//
// Purpose: Setup SHA3_384 method inside the hash state.
//
// Returns:                Reason:
...
//
*/
IPPFUN( IppStatus, ippsHashStateMethodSet_SHA3_384, (IppsHashState_rmf* pState, IppsHashMethod* pMethod) )
{
   /* test pointers */
   ...
   pMethod->hashUpdate    = sha3_384_hashUpdate;
