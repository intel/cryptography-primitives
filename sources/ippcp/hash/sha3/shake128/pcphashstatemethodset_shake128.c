...
/*
//    Name: ippsHashStateMethodSet_SHAKE128
//
// Purpose: Setup SHAKE128 method inside the hash state.
//
// Returns:                Reason:
...
//
*/
IPPFUN( IppStatus, ippsHashStateMethodSet_SHAKE128, (IppsHashState_rmf* pState, IppsHashMethod* pMethod, int digestBitsize) )
{
   /* test pointers */
