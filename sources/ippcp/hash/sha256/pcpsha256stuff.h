...
static const Ipp32u sha256_iv[] = { 0x6A09E667, 0xBB67AE85, 0x3C6EF372, 0xA54FF53A,
                                    0x510E527F, 0x9B05688C, 0x1F83D9AB, 0x5BE0CD19 };
static const Ipp32u sha224_iv[] = { 0xC1059ED8, 0x367CD507, 0x3070DD17, 0xF70E5939,
...
IPP_OWN_DEFN(static void, sha256_hashInit, (void* pHash)) { hashInit((Ipp32u*)pHash, sha256_iv); }
IPP_OWN_DEFN(static void, sha224_hashInit, (void* pHash)) { hashInit((Ipp32u*)pHash, sha224_iv); }
             ...
             (Ipp8u * pMD, void* pHashVal, const int hashByteSize))
{
    ...
    const int hashMaxByteSize = IPP_SHA256_DIGEST_BITSIZE / 8; /* 32 */
...
{
    /* Handle the case when the requested hashByteSize is bigger than supported */
    const int hashMaxByteSize = IPP_SHA224_DIGEST_BITSIZE / 8; /* 28 */
    const int outByteSize     = IPP_MIN(hashByteSize, hashMaxByteSize);
...
/* clang-format off */
IPP_OWN_DECL(IppStatus, cpSHA256MessageDigest, (DigestSHA256 hash,
                                                const Ipp8u* pMsg,
                                                int msgLen,
                                                const DigestSHA256 IV))
/* clang-format on */
#define cpFinalizeSHA256 OWNAPI(cpFinalizeSHA256)
/* clang-format off */
IPP_OWN_DECL(void, cpFinalizeSHA256, (DigestSHA256 pHash,
