...
IPP_OWN_DECL(void, cp_xmss_base_w, (const Ipp8u* pMsg, Ipp32s out_len, Ipp8u* basew, cpWOTSParams* params))

#define cp_do_xmss_hash OWNAPI(cp_do_xmss_hash)
IPP_OWN_DECL(IppStatus, cp_do_xmss_hash, (Ipp32u padding_id, const Ipp8u* key,
                const Ipp8u* msg, Ipp32s msgLen, Ipp8u* out, Ipp8u* temp_buf, const cpWOTSParams* params))

#define cp_xmss_prf OWNAPI(cp_xmss_prf)
IPP_OWN_DECL(IppStatus, cp_xmss_prf, (const Ipp8u* key, const Ipp8u* index, Ipp8u* out, Ipp8u* temp_buf, const cpWOTSParams* params))

#define cp_xmss_chain OWNAPI(cp_xmss_chain)
IPP_OWN_DECL(IppStatus, cp_xmss_chain, (Ipp8u* X, Ipp8u i, Ipp8u s, Ipp8u* pSeed, Ipp8u* adrs,
            Ipp8u* out, Ipp8u* temp_buf, const cpWOTSParams* params))

#define cp_xmss_WOTS_pkFromSig OWNAPI(cp_xmss_WOTS_pkFromSig)
IPP_OWN_DECL(IppStatus, cp_xmss_WOTS_pkFromSig, (const Ipp8u* M, Ipp8u* sig, Ipp8u* pSeed,
            Ipp8u* adrs, Ipp8u* out, Ipp8u* temp_buf, cpWOTSParams* params))

#define cp_xmss_rand_num OWNAPI(cp_xmss_rand_num)
IPP_OWN_DECL(IppStatus, cp_xmss_rand_num, (Ipp8u* out, Ipp32s byteSize,
                IppBitSupplier rndFunc, void* pRndParam))

#define cp_xmss_WOTS_genPK OWNAPI(cp_xmss_WOTS_genPK)
IPP_OWN_DECL(IppStatus, cp_xmss_WOTS_genPK, (Ipp8u* pSecretSeed, Ipp8u* pPublicKey,
                Ipp8u* pPublicSeed, Ipp8u* adrs, Ipp8u* temp_buf, const cpWOTSParams* params))

#define cp_xmss_WOTS_sign OWNAPI(cp_xmss_WOTS_sign)
IPP_OWN_DECL(IppStatus, cp_xmss_WOTS_sign, (const Ipp8u* M, Ipp8u* pSecretSeed, Ipp8u* pSignature,
 ...
 */
 ...
 __IPPCP_INLINE Ipp8u cp_xmss_set_adrs_1_byte(int word_id){
