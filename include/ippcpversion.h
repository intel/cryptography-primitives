...
#define CRYPTO_LIB_VERSION_MAJOR 2
#define CRYPTO_LIB_VERSION_MINOR 4
#define CRYPTO_LIB_VERSION_PATCH 0

// Major interface version
#define CRYPTO_LIB_INTERFACE_VERSION_MAJOR 13
// Minor interface version
#define CRYPTO_LIB_INTERFACE_VERSION_MINOR 4
